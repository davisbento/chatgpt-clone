...
import ClientHttp, { fetcher } from '@/http/httpClient';
...
function ChatItemError({ children }: { children: ReactNode }) {
	return (
		...
		<div className='overflow-hidden w-full h-full relative flex'>
			...
			<div className='flex-1 flex-col relative'>
				<ul id='chatting' className='h-screen overflow-y-auto bg-gray-800'>
					...
					{messageLoading && <ChatItem content={messageLoading} is_from_bot={true} loading={true} />}
